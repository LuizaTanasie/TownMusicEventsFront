                ...
                <div className="container-regular">
                    ...
                    <div className="col col-xs-0 col-sm-4 col-md-4 col-lg-4 ">
                        ...
                        <a href={this.state.artist.Facebook} >
                            <img className="col col-xs-3 col-sm-3 col-md-3 col-lg-3 img-responsive" src="/images/facebook.png" />
                        </a>
                        <a href={this.state.artist.Youtube} >
                            <img className="col col-xs-3 col-sm-3 col-md-3 col-lg-3 img-responsive" src="/images/youtube.png" />
                        </a>
                        <a href={this.state.artist.Instagram} >
                            <img className="col col-xs-3 col-sm-3 col-md-3 col-lg-3 img-responsive" src="/images/instagram.png" />
                        </a>
                        <a href={this.state.artist.Twitter} >
                            <img className="col col-xs-3 col-sm-3 col-md-3 col-lg-3 img-responsive" src="/images/twitter.png" />
                        </a>
