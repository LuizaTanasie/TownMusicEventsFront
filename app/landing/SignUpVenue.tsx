...
export class SignUpVenue extends React.Component<{}, { email: string, name: string, password: string, passwordAgain: string, venueName: string }>
{
    ...
    handleVenueName(event: React.FormEvent<HTMLInputElement>) {
        this.setState({ venueName: event.currentTarget.value });
    }
    render() {
        return (
            <div>
                ...
                <div className="signup-container col col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    <div className="spacing">Înregistrare ca locatie de concerte:<br /><br /></div>
                    <form>
                        ...
                        <div className="spacing">
                            Nume locatie:
                                <input type="text" name="venueName" className="form-control input" onChange={this.handleVenueName} />
                        </div>
                        <div className="spacing">
                            Localizare pe hartă:
